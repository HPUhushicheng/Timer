...
import { ref } from 'vue';
import { ChatDotRound,User,SwitchButton,Operation, Timer, TrendCharts, Bell } from '@element-plus/icons-vue';
...
<template>
  <div class="layout-container">
    ...
    >
      ...
      <el-menu-item index="6" @click="theme" class="tubiao-item">
        <el-icon><ChatDotRound /></el-icon>
        <template #title>更换主题</template>
      </el-menu-item>

      <el-menu-item index="7" @click="Login" class="logout-item">
